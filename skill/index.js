...
const STOP_MESSAGE = "Goodbye and <phoneme alphabet='ipa' ph='məzaʊl'>Mazal</phoneme> <phoneme alphabet='ipa' ph='tɔv'>Tov</phoneme> to you all!!";
...
const data = {
  "adam": [
    ...
    "There is nothing Adam hates more than the song 'Africa' by the band Toto.", 
    ...
    "Many of his Adam's closest friends find that it is really strange that he loves to pee outside any chance he gets.",
    ...
    "Adam has a tattoo of his favorite camera lens on his forearm. Ask him about it, he will LOVE to explain it at length to you.",
    "Adam faked a neck injury for an entire year in High School to get out of Gym class.",
    "Adam went all goth for a month because apparently black is slimming. ",
    "In high school, Adam used to beg for quarters just to buy a bowl of rice from the Tea Garden chinese restaurant.",
    "Adam won a prize for being a beautiful baby and smiling angelically. He won a lovely large framed photo.",
    ...
    "Adam was once a proud Junior Hornet who attended every Watford FC Saturday soccer game. He was born in the hospital next door to Vicarage Road, the sacred home of the Hornets.",
  ...
  "monica": [
    ...
    "Monica was once early twenty first century rap sensation Eminem’s biggest fan",
    ...
    "Monica's mom, <phoneme alphabet='ipa' ph='tæssənə'>Tassana</phoneme>, first discovered monica was OCD when she would keep tying her shoelaces till both loops and both tails were even and perfectly symmetrical.  This could take forever.", 
    ...
    "One time when Monica's brother Aaron threw a party at the house while his parents were out, a friend rushed in to warn him about a imminent threat.  Aaron asked, 'Are the cops coming?'  His friend replied, 'No, it's worse. It's your sister!!!!'",  
...
"Monica's mom, <phoneme alphabet='ipa' ph='tæssənə'>Tassana</phoneme>, used to dress Monica every day and always thought that she looked cute!  One day Monica decided that her Mom didn't know how to dress her and Monica rebelled with a vengeance!!  Of course, it had to be Coach, <phoneme alphabet='ipa' ph='lui'>Luis</phoneme> Vuitton, and other expensive name brands - plus, of course, hair straightening."  ,
    ...
    "Monica doesn't know how to type. She types with three fingers and always does so very, very loudly.",
    ...
    "Monica didn't go to the gym for about 6 months only because she had to buy a new pair of sneakers. (Do Toms make workout sneakers?).",
    ...
    "Monica and her friend Laura, aptly almost fell off a roof in Nepal singing karaoke to Lady Gaga's song, 'I'm on the edge.'" 
  ]
};
